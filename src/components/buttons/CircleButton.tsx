    ...
    const classStr = solidTwMerge(
        ...
        clsx(
            ...
            ],
            {
                ...
                "bg-secondary text-white hover:bg-secondary-600 active:bg-secondary-700 dark:hover:bg-secondary-400 dark:active:bg-secondary-300 focus:outline-none focus:ring focus:ring-secondary-300":
                    local?.buttonColor == "secondary",
                "bg-tertiary-500 text-white hover:bg-tertiary-600 active:bg-tertiary-700 dark:hover:bg-tertiary-400 dark:active:bg-tertiary-300 focus:outline-none focus:ring focus:ring-tertiary-300":
