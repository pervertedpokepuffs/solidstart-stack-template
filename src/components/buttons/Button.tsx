...
export const Button: Component<ButtonProps> = (props) => {
    ...
    const classStr = solidTwMerge(
        ...
        clsx(
            ...
            {
                "bg-slate-50 dark:text-white dark:bg-slate-500 text-current hover:bg-slate-200 active:bg-slate-300 dark:hover:bg-slate-400 dark:active:bg-slate-300 focus:ouline-none focus:ring focus:ring-slate-200": !local?.buttonColor,
